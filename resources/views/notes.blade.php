            ...
            <div class="grid grid-cols-3 bg-white rounded-lg shadow relative z-40 mx-auto h-4/5 my-auto w-2/3 px-2 py-2 gap-2">
                ...
                <div class="border-2 border-slate-200 rounded-lg">
                    <div class="item">
                        ...
                        <div class="notes">
                            <ul class="gap-4 grid">
                                <li class="flex flex-row gap-2 items-baseline border-b-2 pb-2 px-1">
                                    <span class="fa fa-circle text-[8px] text-green-400"></span>
                                    <span class="text-xs">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam adipisci omnis sm.</span>
                                </li>
                            <li class="flex flex-row gap-2 items-baseline border-b-2 pb-2 px-1">
                                    <span class="fa fa-circle text-[8px] text-green-400"></span>
                                    <span class="text-xs">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam adipisci omnis sm.</span>
                                </li><li class="flex flex-row gap-2 items-baseline border-b-2 pb-2 px-1">
                                    <span class="fa fa-circle text-[8px] text-green-400"></span>
                                    <span class="text-xs">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam adipisci omnis sm.</span>
                                </li><li class="flex flex-row gap-2 items-baseline border-b-2 pb-2 px-1">
                                    <span class="fa fa-circle text-[8px] text-green-400"></span>
